...
<div id="allBody">
                ...
                <ul class="menu">
                    <li><a href=""><img src="${sessionScope.admin.adminphoto}" class="touxiangimg" id="touxiaoimg"><span id="loginName" style="height: 30px;font-size: 14px;line-height: 30px">${sessionScope.admin.adminname}</span></a>
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/admin/EducAndComp/EducAndCompMain.do">签名盖章管理</a>
                            </li>
    ...
    <div class="row col-md-offset-3" style="position: relative;right: -25px;margin-top: 20px">
        <div class="col-md-7">
            <form role="form" action="${pageContext.request.contextPath}/admin/EducAndComp/SelectEducAndComp.do"
    ...
    <div class="test" style="height: 797px">
        <div class="table">
            ...
            <c:forEach items="${pageInfo.list}" var="EducAndComp">
                <div class="body">
                    <div id="stud_id">${EducAndComp.studId}</div>
                    <div id="departName">${EducAndComp.students.department.departname}</div>
                    <div id="major">${EducAndComp.students.major}</div>
                    <div id="sclass">${EducAndComp.students.sclass}</div>
                    <div id="grade">${EducAndComp.students.grade}</div>
                    <div id="education">${EducAndComp.students.education}</div>
                    <div id="studname">${EducAndComp.students.studname}</div>
                    <div id="studsex">${EducAndComp.students.studsex}</div>
                    <div id="studphone1">${EducAndComp.students.studphone1}</div>
                    <div id="studphone2">${EducAndComp.students.studphone2}</div>
                    <div id="adress">${EducAndComp.students.adress}</div>
                    <div id="familyphone">${EducAndComp.students.familyphone}</div>
                    <div id="rentdesc">${EducAndComp.rentdesc}</div>
                    <div id="adminname">${EducAndComp.admin.adminname}</div>
                    <div id="signtime"><fmt:formatDate value="${EducAndComp.signtime}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form"
                                  action="${pageContext.request.contextPath}/admin/EducAndComp/EducAndCompSign.do" id="edit">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/admin/EducAndComp/distribution.do?pn=1">首页</a>
                            </li>
                            <li>
                                <c:if test="${pageInfo.hasPreviousPage}">
                                    <a href="${pageContext.request.contextPath}/admin/EducAndComp/distribution.do?pn=${pageInfo.pageNum-1}"
                                       aria-label="Previous">
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                <c:if test="${page_num==pageInfo.pageNum}">
                                    <li class="active"><a
                                            href="${pageContext.request.contextPath}/admin/EducAndComp/distribution.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                                <c:if test="${page_num!=pageInfo.pageNum}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/admin/EducAndComp/distribution.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/EducAndComp/distribution.do?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    ...
    function downloadSuppcenfile() {
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/EducAndComp/ExportEducAndCompFromDB.do",
            type: "POST",
            data: {
                filePath: "123"
            },
        ...
        function return_data(data) {
            ...
            window.location.replace("${pageContext.request.contextPath}/admin/EducAndComp/default.do");
        }
    ...
    function signAll() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/EducAndComp/EducAndCompSignAll.do",
            type: "POST",
            data: {
                adminid: adminid
            },
        ...
        function return_data(data) {
            ...
            window.location.replace("${pageContext.request.contextPath}/admin/EducAndComp/distribution.do");
        }
...
<script>
    ...
    function fileLoad(ele){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/EducAndComp/ImportEducAndCompToDB.do",
            type: 'POST',
            data: formData,
            ...
            success: function (responseStr) {
                ...
                $("#textfield").val('');
                $("#importfile").val('');
                window.location.href = "${pageContext.request.contextPath}/admin/EducAndComp/default.do";
            }
            ,
