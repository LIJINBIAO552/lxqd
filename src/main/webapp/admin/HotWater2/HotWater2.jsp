...
<div id="allBody">
                ...
                <ul class="menu">
                    <li><a href=""><img src="${sessionScope.admin.adminphoto}" class="touxiangimg" id="touxiaoimg"><span id="loginName" style="height: 30px;font-size: 14px;line-height: 30px">${sessionScope.admin.adminname}</span></a>
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/admin/HotWater2/HotWater2Main.do">签名盖章管理</a>
                            </li>
    ...
    <div class="row col-md-offset-3" style="position: relative;right: -25px;margin-top: 20px">
        <div class="col-md-7">
            <form role="form" action="${pageContext.request.contextPath}/admin/HotWater2/SelectHotwater2.do"
    ...
    <div class="test" style="height: 797px">
        <div class="table">
            ...
            <c:forEach items="${pageInfo.list}" var="HotWater2">
                <div class="body">
                    <div id="stud_id">${HotWater2.studId}</div>
                    <div id="departName">${HotWater2.students.department.departname}</div>
                    <div id="major">${HotWater2.students.major}</div>
                    <div id="sclass">${HotWater2.students.sclass}</div>
                    <div id="grade">${HotWater2.students.grade}</div>
                    <div id="education">${HotWater2.students.education}</div>
                    <div id="studname">${HotWater2.students.studname}</div>
                    <div id="studsex">${HotWater2.students.studsex}</div>
                    <div id="studphone1">${HotWater2.students.studphone1}</div>
                    <div id="studphone2">${HotWater2.students.studphone2}</div>
                    <div id="adress">${HotWater2.students.adress}</div>
                    <div id="familyphone">${HotWater2.students.familyphone}</div>
                    <div id="hw2pay">${HotWater2.hw2pay}</div>
                    <div id="adminname">${HotWater2.admin.adminname}</div>
                    <div id="signtime"><fmt:formatDate value="${HotWater2.signtime}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form"
                                  action="${pageContext.request.contextPath}/admin/HotWater2/Hotwater2Sign.do" id="edit">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/admin/HotWater2/distributionHotwater2.do?pn=1">首页</a>
                            </li>
                            <li>
                                <c:if test="${pageInfo.hasPreviousPage}">
                                    <a href="${pageContext.request.contextPath}/admin/HotWater2/distributionHotwater2.do?pn=${pageInfo.pageNum-1}"
                                       aria-label="Previous">
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                <c:if test="${page_num==pageInfo.pageNum}">
                                    <li class="active"><a
                                            href="${pageContext.request.contextPath}/admin/HotWater2/distributionHotwater2.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                                <c:if test="${page_num!=pageInfo.pageNum}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/admin/HotWater2/distributionHotwater2.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/HotWater2/distributionHotwater2.do?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    ...
    function downloadSuppcenfile() {
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/HotWater2/ExportHotwater2FromDB.do",
            type: "POST",
            data: {
                filePath: "123"
            },
        ...
        function return_data(data) {
            ...
            window.location.replace("${pageContext.request.contextPath}/admin/HotWater2/default.do");
        }
    ...
    function signAll() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/HotWater2/Hotwater2SignAll.do",
            type: "POST",
            data: {
                adminid: adminid
            },
        ...
        function return_data(data) {
            ...
            window.location.replace("${pageContext.request.contextPath}/admin/HotWater2/distributionHotwater2.do");
        }
...
<script>
    ...
    function fileLoad(ele){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/HotWater2/ImportHotwater2ToDB.do",
            type: 'POST',
            data: formData,
            ...
            success: function (responseStr) {
                ...
                $("#textfield").val('');
                $("#importfile").val('');
                window.location.href = "${pageContext.request.contextPath}/admin/HotWater2/default.do";
            }
            ,
