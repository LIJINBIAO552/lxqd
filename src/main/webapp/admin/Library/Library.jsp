...
<div id="allBody">
                ...
                <ul class="menu">
                    <li><a href=""><img src="${sessionScope.admin.adminphoto}" class="touxiangimg" id="touxiaoimg">
                        ...
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/admin/Library/LibraryMain.do">签名盖章管理</a>
                            </li>
    ...
    <div class="row col-md-offset-3" style="position: relative;right: -25px;margin-top: 20px">
        <div class="col-md-7">
            <form role="form" action="${pageContext.request.contextPath}/admin/Library/SelectLibrary.do"
        ...
        <div class="col-md-5">
            ...
            <button class="btn btn-info btn-search" onclick="signAll()">
                <span class="glyphicon glyphicon-save" aria-hidden="true"></span>一键签名盖章
            </button>
        </div>
    </div>
    <div class="test" style="height: 797px">
        <div class="table">
            ...
            <c:forEach items="${pageInfo.list}" var="Library">
                <div class="body">
                    <div id="stud_id">${Library.studId}</div>
                    <div id="departName">${Library.students.department.departname}</div>
                    <div id="major">${Library.students.major}</div>
                    <div id="sclass">${Library.students.sclass}</div>
                    <div id="grade">${Library.students.grade}</div>
                    <div id="education">${Library.students.education}</div>
                    <div id="studname">${Library.students.studname}</div>
                    <div id="studsex">${Library.students.studsex}</div>
                    <div id="studphone1">${Library.students.studphone1}</div>
                    <div id="studphone2">${Library.students.studphone2}</div>
                    <div id="adress">${Library.students.adress}</div>
                    <div id="familyphone">${Library.students.familyphone}</div>
                    <div id="nedesc">${Library.nedesc}</div>
                    <div id="adminname">${Library.admin.adminname}</div>
                    <div id="signtime"><fmt:formatDate value="${Library.signtime}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form"
                                  action="${pageContext.request.contextPath}/admin/Library/LibrarySign.do" id="edit">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/admin/Library/distributionLibrary.do?pn=1">首页</a>
                            </li>
                            <li>
                                <c:if test="${pageInfo.hasPreviousPage}">
                                    <a href="${pageContext.request.contextPath}/admin/Library/distributionLibrary.do?pn=${pageInfo.pageNum-1}"
                                       aria-label="Previous">
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                <c:if test="${page_num==pageInfo.pageNum}">
                                    <li class="active"><a
                                            href="${pageContext.request.contextPath}/admin/Library/distributionLibrary.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                                <c:if test="${page_num!=pageInfo.pageNum}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/admin/Library/distributionLibrary.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/Library/distributionLibrary.do?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    ...
    function downloadSuppcenfile() {
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/Library/ExportLibraryFromDB.do",
            type: "POST",
            data: {
                filePath: "123"
            },
        ...
        function return_data(data) {
            ...
            window.location.replace("${pageContext.request.contextPath}/admin/Library/default.do");
        }
    ...
    function signAll() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/Library/LibrarySignAll.do",
            type: "POST",
            data: {
                adminid: adminid
            },
...
<script>
    ...
    function fileLoad(ele){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/Library/ImportLibraryToDB.do",
            type: 'POST',
            data: formData,
            ...
            success: function (responseStr) {
                ...
                $("#textfield").val('');
                $("#importfile").val('');
                window.location.href = "${pageContext.request.contextPath}/admin/Library/default.do";
            }
            ,
