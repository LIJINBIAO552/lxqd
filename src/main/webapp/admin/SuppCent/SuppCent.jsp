...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/SuppCent.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/css/menu.css" rel="stylesheet">

    <script src="${pageContext.request.contextPath}/js/jquery-1.10.2.js"></script>
    <script src="${pageContext.request.contextPath}/js/bootstrap.js"></script>
    <script src="${pageContext.request.contextPath}/js/jquery.metisMenu.js"></script>
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/js/html2canvas.js"></script>


</head>
<body>

<div id="allBody" style="width: 100%;height: 100%">
                ...
                <ul class="menu">
                    <li><a href=""><img src="${sessionScope.admin.adminphoto}" class="touxiangimg" id="touxiaoimg">
                        ...
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/admin/SuppCent/SuppCentMain.do">签名盖章管理</a>
                            </li>
                ...
                <ul style="background-color: white;padding: 10px 10px 30px 10px">
                    <div class="upload">
                        <form enctype="multipart/form-data">
                            ...
                            <input type="file" id="importfile" name="multipartFile" class="file" size="28" onchange="document.getElementById('textfield').value=this.value"/>
                        </form>
                    </div>
                </ul>
            </li>
    ...
    <div class="row col-md-offset-3" style="position: relative;right: -25px;margin-top: 20px">
        <div class="col-md-7">
            <form role="form" action="${pageContext.request.contextPath}/admin/SuppCent/SelectSuppCent.do"
    ...
    <div class="test" style="height: 797px">
        <div class="table">
            ...
            <c:forEach items="${pageInfo.list}" var="Suppcent">
                <div class="body">
                    <div id="stud_id">${Suppcent.studId}</div>
                    <div id="departName">${Suppcent.students.department.departname}</div>
                    <div id="major">${Suppcent.students.major}</div>
                    <div id="sclass">${Suppcent.students.sclass}</div>
                    <div id="grade">${Suppcent.students.grade}</div>
                    <div id="education">${Suppcent.students.education}</div>
                    <div id="studname">${Suppcent.students.studname}</div>
                    <div id="studsex">${Suppcent.students.studsex}</div>
                    <div id="studphone1">${Suppcent.students.studphone1}</div>
                    <div id="studphone2">${Suppcent.students.studphone2}</div>
                    <div id="adress">${Suppcent.students.adress}</div>
                    <div id="familyphone">${Suppcent.students.familyphone}</div>
                    <div id="suppDesc">${Suppcent.suppdesc}</div>
                    <div id="adminname">${Suppcent.admin.adminname}</div>
                    <div id="signtime"><fmt:formatDate value="${Suppcent.signtime}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
                    <div>
                        <!--签名按钮触发模态框-->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form"
                                  action="${pageContext.request.contextPath}/admin/SuppCent/SuppCentSign.do" id="edit">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/admin/SuppCent/distribution.do?pn=1">首页</a>
                            </li>
                            <li>
                                <c:if test="${pageInfo.hasPreviousPage}">
                                    <a href="${pageContext.request.contextPath}/admin/SuppCent/distribution.do?pn=${pageInfo.pageNum-1}"
                                       aria-label="Previous">
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                <c:if test="${page_num==pageInfo.pageNum}">
                                    <li class="active"><a
                                            href="${pageContext.request.contextPath}/admin/SuppCent/distribution.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                                <c:if test="${page_num!=pageInfo.pageNum}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/admin/SuppCent/distribution.do?pn=${page_num}">${page_num}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/SuppCent/distribution.do?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    ...
    function downloadSuppcenfile() {
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/SuppCent/ExportSuppCentFromDB.do",
            type: "POST",
            data: {
                filePath: "123"
            },
        ...
        function return_data(data) {
            ...
            window.location.replace("${pageContext.request.contextPath}/admin/SuppCent/default.do");
        }
    ...
    function signAll() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/SuppCent/SuppCentSignAll.do",
            type: "POST",
            data: {
                adminid: adminid
            },
...
<script>
    ...
    function fileLoad(ele){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/SuppCent/ImportSuppcentToDB.do",
            type: 'POST',
            data: formData,
            ...
            success: function (responseStr) {
                ...
                $("#textfield").val('');
                $("#importfile").val('');
                window.location.href = "${pageContext.request.contextPath}/admin/SuppCent/distribution.do";
            }
            ,
