...
<body>
    <div style="width:100%;margin:28px 33.5%">
        <form class="layui-form" action="" style="width: 700px;height: 500px;">
                        ...
                        <div style="padding-top: 20px">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="adminid" name="adminid" lay-verify="required" readonly="readonly" placeholder="请输入"
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input id="adminname" name="adminname" lay-verify="required" autocomplete="off" placeholder="请输入"
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input id="departid" name="departid" lay-verify="required" autocomplete="off" placeholder="请输入"
                    ...
                    <div class="grid-demo">
                        <div class="layui-upload" style="padding-left: 10px">
                            <div class="layui-upload-list">
                                <img class="layui-upload-img" style="height: 200px;width: 142.8px;" id="adminPhoto" src="${MySelfOfAdmin.adminphoto}">
                                <p id="demoText"></p>
                            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input id="adminiden" name="adminiden" lay-verify="identity" autocomplete="off" placeholder="请输入" class="layui-input"
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input id="adminphone" name="adminphone" lay-verify="required|phone" autocomplete="off" placeholder="请输入"
