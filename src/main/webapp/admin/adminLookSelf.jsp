...
<script>
    $(function () {
        console.log(".....++++----"+$("#adminPhoto").attr("src").length);
...
<script>
    layui.use(['form', 'layedit'], function () {
        ...
        form.render();
        //监听提交
        form.on('submit(editAdmin)', function (data) { //这块要跟表单中的lay-filter="editAdmin"对应
            $.ajax({
                ...
                success: function (data) {
                    if (data.msg === '1') {
                        layer.alert("更新成功", {icon: 1, time: 2000}, function () {
